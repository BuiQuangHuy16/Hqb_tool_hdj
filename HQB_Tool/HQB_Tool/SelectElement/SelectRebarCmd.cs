...
namespace HqbTool
{
    ...
    public class SelectRebarCmd : IExternalCommand
    {
            ...
            ref string message, ElementSet elements)
        {
            ...
            if (reference != null)
            {
                ...
                Parameter ConTrolMark = element.LookupParameter("CONTROL_MARK");
                ElementId elementId = ConTrolMark.Id;

                string ValueConTrolMark = ConTrolMark.AsString();


                FilterRule rule1 = ParameterFilterRuleFactory.CreateEqualsRule(elementId, ValueConTrolMark, true);
