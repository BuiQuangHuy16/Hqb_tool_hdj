...
namespace HqbTool
{
    ...
    public class SelectEbedsCmd : IExternalCommand
    {
            ...
            ref string message, ElementSet elements)
        {
            ...
            foreach (Reference r in listrReferences)
            {
                ...
                Parameter type
                    = e.LookupParameter("Type");
                ElementId typeId = type.Id; 
                string valueType = type.AsValueString();

                FilterRule rule1 =
                    ParameterFilterRuleFactory.CreateEqualsRule(typeId, valueType, true);
