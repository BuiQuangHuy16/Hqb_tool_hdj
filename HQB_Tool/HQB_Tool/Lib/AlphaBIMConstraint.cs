...
namespace HqbTool
{
    public class AlphaBIMConstraint
    {
        ...
        #endregion
        public AlphaBIMConstraint(ControlledApplication a = null)
        {
            #region   Khởi tạo giá trị cho các Field Constraint
            ContentsFolder = @"C:\ProgramData\Autodesk\Revit\Addins";
            SettingFolder =
                @"C:\ProgramData\Autodesk\Revit\Addins\Resources\Setting";
